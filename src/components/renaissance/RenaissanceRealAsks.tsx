...
import { GenieMorphCard } from './GenieMorphCard';
    ...
    >
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-8 lg:px-12 relative z-20">
        ...
        {/* =========================================================================
            ...
            ========================================================================= */}
        <div className="relative w-full max-w-4xl mx-auto min-h-[580px] sm:min-h-[640px] flex flex-col items-center">
          
          {/* Main SVG Morphing Genie Container */}
          <div className="w-full flex justify-center">
            <GenieMorphCard isOpen={isOpen} onToggle={handleToggle} />
          </div>
