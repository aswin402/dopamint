        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-6 items-end">
          ...
          <div className="lg:col-span-7 relative w-full h-[480px] sm:h-[520px] lg:h-[560px] select-none pb-6 sm:pb-8">
            ...
            >
              ...
              <div className="p-3 rounded-2xl bg-white backdrop-blur-md border border-neutral-200/90 shadow-md space-y-1.5">
            ...
            >
              ...
              <div className="p-2.5 sm:p-3 rounded-2xl bg-white backdrop-blur-md border border-neutral-200/90 shadow-md space-y-1.5">
            ...
            >
              ...
              <div className="p-2.5 sm:p-3 rounded-2xl bg-white backdrop-blur-md border border-neutral-200/90 shadow-md space-y-1">
