...
export const RenaissanceFooter: React.FC = () => {
  return (
    <footer className="relative w-full min-h-[700px] sm:min-h-[850px] lg:min-h-[960px] bg-black text-white flex flex-col justify-between overflow-hidden select-none">
      ...
      <div className="relative z-10 max-w-5xl mx-auto px-4 pt-16 sm:pt-24 lg:pt-32 text-center space-y-6 sm:space-y-8">
        ...
        <h2 className="font-serif text-4xl sm:text-6xl md:text-7xl lg:text-[76px] text-white tracking-tight leading-[1.08] drop-shadow-[0_4px_24px_rgba(0,0,0,0.6)]">
          Give your <span className="font-serif italic font-bold">AI some</span> agency.
          <br />
          Not a blank check.
        </h2>
