...
import { ArrowRight, CheckCircle2, TrendingUp, Radio, Activity, ShieldCheck } from 'lucide-react';
  ...
  return (
    <section id="onchain" className="w-full bg-[#363928] text-white py-24 px-4 sm:px-8 lg:px-12 relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto relative z-20">
        ...
        {/* Chapter Marker */}
        <div className="flex items-center justify-between text-xs font-mono text-[#a4a991] mb-8 pb-3 border-b border-[#4f533e]">
          <span>ONCHAIN ACTIONS // MACHINE EXECUTION</span>
          <span className="font-serif italic text-base text-white">Onchain actions</span>
        </div>
        ...
        <div className="max-w-3xl mb-16 space-y-4 text-left">
          <h2 className="text-4xl sm:text-6xl font-black text-display text-white tracking-tight leading-[0.96]">
            Stuff it can <br />
            <span className="font-serif italic font-normal text-[#d6cebe]">
        ...
        <div className="space-y-6 mb-16">
          <div className="flex items-center gap-2 text-xs font-mono font-bold text-[#c2caa8] uppercase">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-stretch">
            ...
            <div className="p-8 rounded-3xl bg-[#282a1e]/90 border border-[#4d523b] shadow-2xl space-y-6 flex flex-col justify-between relative overflow-hidden backdrop-blur-sm">
              ...
              <div className="p-4 rounded-2xl bg-[#1c1e15] border border-[#3f4330] shadow-inner space-y-3 font-mono">
                <div className="flex items-center justify-between text-[11px] pb-2 border-b border-[#353928]">
                  <span className="text-[#a4a991] uppercase font-bold flex items-center gap-1.5">
                    <Activity className="w-3.5 h-3.5 text-emerald-400" />
                    <span>DEX Route Synthesis</span>
                  </span>
                  <span className="text-emerald-400 font-bold text-[10px] bg-emerald-950/70 px-2 py-0.5 rounded-full border border-emerald-500/30">
                    Optimal · Base L2
                  </span>
                </div>
                ...
                <div className="grid grid-cols-3 items-center text-center gap-2 py-2 relative">
                  {/* Step 1: Input */}
                  <div className="p-2.5 rounded-xl bg-[#2b2d20] border border-[#484c35]">
                    <div className="text-[10px] text-neutral-400 font-bold uppercase">PAY</div>
                    <div className="text-xs font-black text-white">500 USDC</div>
                  </div>

                  {/* Step 2: Bridge/Router with animated pulse */}
                  <div className="flex flex-col items-center justify-center relative">
                    <div className="w-full h-0.5 bg-[#484c35] relative overflow-hidden">
                      <motion.div
                        animate={{ x: ['-100%', '100%'] }}
                        transition={{ duration: 1.5, repeat: Infinity, ease: 'linear' }}
                        className="w-8 h-full bg-emerald-400 rounded-full"
                      />
                    </div>
                    <div className="mt-1 text-[9px] font-bold text-[#b5bca1]">Uniswap v3</div>
                  </div>

                  {/* Step 3: Output */}
                  <div className="p-2.5 rounded-xl bg-[#2b2d20] border border-[#484c35]">
                    <div className="text-[10px] text-neutral-400 font-bold uppercase">RECEIVE</div>
                    <div className="text-xs font-black text-emerald-400">≈ 0.1471 ETH</div>
                  </div>
                </div>

                {/* Execution Telemetry Badges */}
                <div className="grid grid-cols-2 gap-2 text-[10px] text-neutral-400 pt-1">
                  <div>Price Impact: <span className="font-bold text-white">&lt;0.01%</span></div>
                  <div className="text-right">Gas Estimate: <span className="font-bold text-emerald-300">$0.0018</span></div>
                </div>
              </div>
              ...
              <button
                ...
                disabled={isSwapping}
                className="p-4 rounded-2xl bg-[#1d1f16] border border-[#4d523b] font-mono text-xs text-white font-bold flex items-center justify-between shadow-lg hover:border-emerald-400 hover:bg-[#25281c] transition-all cursor-pointer w-full group"
              >
                <span className="flex items-center gap-2">
                  <span className={`w-2 h-2 rounded-full ${swapDone ? 'bg-emerald-400' : isSwapping ? 'bg-amber-400 animate-ping' : 'bg-emerald-400'}`} />
                  <span>
                    {isSwapping
                ...
                <ArrowRight className={`w-4 h-4 text-neutral-400 transition-transform ${isSwapping ? 'rotate-90 animate-spin' : 'group-hover:translate-x-1 text-white'}`} />
              </button>
            </div>

            {/* 2. x402 Payments with curl call & Handshake Trace */}
            <div className="p-8 rounded-3xl bg-[#212318] text-white shadow-2xl space-y-6 flex flex-col justify-between border border-[#484c35]">
              <div className="space-y-3">
                <div className="flex items-center justify-between">
                  <h3 className="text-2xl font-black text-white font-sans">
                    x402 payments
              ...
              <div className="p-4 rounded-2xl bg-[#14160f] border border-[#353928] font-mono text-[11px] text-neutral-300 space-y-2 overflow-x-auto leading-relaxed shadow-inner">
                <div className="flex items-center justify-between pb-1.5 border-b border-[#2d3122] text-[10px] text-neutral-400">
              ...
              <div className="p-3 rounded-xl bg-[#181a12] border border-[#3d422f] flex items-center justify-between text-xs font-mono text-neutral-400">
                <span className="flex items-center gap-1.5">
                  <ShieldCheck className="w-4 h-4 text-emerald-400" />
                  <span className="text-neutral-300">Zero pre-shared API keys</span>
                </span>
                <span className="text-emerald-300 font-bold">Automatic Settlement ✓</span>
              </div>
            </div>
        ...
        <div className="space-y-6 mb-20">
          <div className="flex items-center gap-2 text-xs font-mono font-bold text-[#c2caa8] uppercase">
            <span className="w-2 h-2 rounded-full bg-[#e0dacb]" />
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-stretch">
            ...
            <div className="p-8 rounded-3xl bg-[#282a1e]/90 border border-[#4d523b] shadow-2xl space-y-6 flex flex-col justify-between relative overflow-hidden backdrop-blur-sm">
              ...
              <div className="p-4 rounded-2xl bg-[#1c1e15] border border-[#3f4330] shadow-inner space-y-2.5 font-mono text-xs">
                <div className="flex items-center justify-between text-[11px] pb-2 border-b border-[#353928]">
                  <span className="font-bold text-white uppercase flex items-center gap-1.5">
                    <TrendingUp className="w-3.5 h-3.5 text-emerald-400" />
                    <span>OKX Order Book · ETH/USDT</span>
                  </span>
                  <span className="text-[#a4a991] font-bold text-[10px]">SPREAD: $0.10</span>
                </div>

                {/* Order Book Depth Rows */}
                <div className="space-y-1.5 text-[11px]">
                  {/* Ask (Red) */}
                  <div className="flex items-center justify-between text-neutral-300 relative overflow-hidden p-1 rounded-sm">
                    <div className="absolute top-0 right-0 h-full bg-red-500/20 w-[35%] pointer-events-none" />
                    <span className="text-red-400 font-bold">$3,401.50</span>
                    <span className="text-neutral-400">1.24 ETH</span>
                  </div>
                  {/* Ask Target (Highlighted Match) */}
                  <div className="flex items-center justify-between text-white relative overflow-hidden p-1 rounded-md bg-emerald-950/40 border border-emerald-500/30">
                    <div className="absolute top-0 right-0 h-full bg-emerald-500/25 w-[65%] pointer-events-none" />
                    <span className="text-emerald-300 font-black flex items-center gap-1">
                      <span className="w-1.5 h-1.5 rounded-full bg-emerald-400 animate-pulse" />
                      <span>$3,398.20 (FILLED)</span>
                    </span>
                    <span className="text-emerald-200 font-bold">0.40 ETH</span>
                  </div>
                  {/* Bid (Green) */}
                  <div className="flex items-center justify-between text-neutral-300 relative overflow-hidden p-1 rounded-sm">
                    <div className="absolute top-0 right-0 h-full bg-emerald-500/20 w-[45%] pointer-events-none" />
                    <span className="text-emerald-400 font-bold">$3,396.10</span>
              ...
              >
                <span className="flex items-center gap-2">
                  <span className={`w-2 h-2 rounded-full ${isSimulatingTrade ? 'bg-amber-400 animate-ping' : 'bg-emerald-400'}`} />
                  <span>{isSimulatingTrade ? 'Executing API Fill on OKX...' : 'Sell 0.4 ETH · OKX · Market (Executed ✓)'}</span>
                </span>
                <ArrowRight className={`w-4 h-4 text-neutral-400 transition-transform ${isSimulatingTrade ? 'rotate-90 animate-spin' : 'group-hover:translate-x-1 text-white'}`} />
              </button>
            </div>
            ...
            <div className="p-8 rounded-3xl bg-[#282a1e]/90 border border-[#4d523b] shadow-2xl space-y-6 flex flex-col justify-between relative overflow-hidden backdrop-blur-sm">
              <div className="space-y-3">
                <div className="flex items-center justify-between">
                  ...
                  <span className="text-xs font-mono font-bold px-3 py-1 rounded-full bg-amber-950/80 text-amber-300 border border-amber-500/40 flex items-center gap-1.5">
                  ...
                  <button
                    ...
                    className={`px-3 py-2 rounded-xl font-mono text-[11px] font-bold border transition-all cursor-pointer text-left ${
                      activeAlertIndex === idx
                        ...
                        : 'bg-[#1e2017] border-[#484c35] text-neutral-300 hover:bg-[#2c2f21] hover:text-white'
                    }`}
                  >
                    {alert}
                  </button>
              ...
              <div className="p-4 rounded-2xl bg-[#1c1e15] border border-[#3f4330] shadow-inner font-mono text-xs space-y-2">
                <div className="flex items-center justify-between text-[10px] pb-1.5 border-b border-[#353928]">
                  <span className="text-[#a4a991] uppercase font-bold">
                    {alertDetails[activeAlertIndex].title}
                  </span>
                  <span className="px-2 py-0.5 rounded-full bg-emerald-950/80 text-emerald-300 font-bold border border-emerald-500/40 text-[9px]">
                    {alertDetails[activeAlertIndex].status}
                  </span>
                </div>
                <div className="text-[11px] text-neutral-300">
                  <span className="text-neutral-400">Trigger Condition: </span>
                  <span className="font-bold text-white">{alertDetails[activeAlertIndex].trigger}</span>
                </div>
        ...
        <div id="machine-to-machine" className="pt-16 border-t border-[#4f533e]">
          <div className="max-w-3xl mb-12 space-y-3 text-left">
            <div className="text-xs font-mono uppercase font-bold text-[#c2caa8]">Machine to machine</div>
            <h2 className="text-3xl sm:text-5xl font-black text-display text-white tracking-tight leading-[0.98]">
              Agents talking <br />
              <span className="font-serif italic font-normal text-[#d6cebe]">
                to agents.
              </span>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 mb-12 items-stretch">
            ...
            <div className="lg:col-span-7 p-8 rounded-3xl bg-[#1d1f16] text-white shadow-2xl flex flex-col justify-between space-y-6 border border-[#484c35]">
              <div className="space-y-4">
                <div className="flex items-center justify-between pb-3 border-b border-[#353928] text-xs font-mono">
                ...
                <div className="p-4 rounded-2xl bg-[#13150e] font-mono text-xs space-y-2.5 border border-[#2b2e1f]">
                ...
                <div className="p-3.5 rounded-2xl bg-emerald-950/40 border border-emerald-500/40 flex items-center gap-2 font-mono text-xs text-emerald-300 font-bold">
            ...
            <div className="lg:col-span-5 flex flex-col justify-between gap-4">
              <div className="p-6 rounded-2xl bg-[#282a1e]/90 border border-[#4d523b] shadow-xl space-y-2 text-left">
                <h4 className="text-base font-black text-white font-sans flex items-center gap-2">
