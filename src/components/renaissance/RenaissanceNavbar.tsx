...
export const RenaissanceNavbar: React.FC = () => {
  ...
  return (
    <header
      className={`fixed top-0 left-0 right-0 z-50 py-4 px-4 sm:px-8 lg:px-12 flex items-center justify-between text-xs font-sans transition-all duration-500 ease-in-out ${
        isScrolled
